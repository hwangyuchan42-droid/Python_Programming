...
print(next(it))             # 인덱스 1을 반환하고, 다음 위치(인덱스 2)로 이동print
print(next(it))       
print(next(it))       
print(next(it))       
print(next(it))       
...
a= "python"
print(a[0::6])                       # Python 출력 (step이 양수이면 끝까지, 마지막 인덱스 포함)
...
s = "1301"
sa=s[2:]
print(f"{s[0]}학년 {s[1]}반 {sa}번")              # ✅ "1학년 3반 1번" 출력
