...
# print(dir(int))                      # int 자료형이 제공하는 속성과 메소드 목록
# print(dir([]))                      # list 자료형이 제공하는 속성과 메소드 목록

# len() 함수: 객체의 길이를 반환하는 파이썬 내장 함수
print(len(a))                       # 문자열의 길이
print(len([1, 2, 3, 4, 5]))               # 리스트의 길이(요소의 개수)
...
print("[" + a.strip() + "]")       # 왼쪽 공백문자 제거
print("[" + a.rstrip() + "]")      # 오른쪽 공백문자 제거
print("[" + a.lstrip() + "]")      # 양쪽 공백문자 제거

a = "***python***"
print("[" + a.strip("*") + "]")                # 왼쪽 특정문자 제거
print("[" + a.rstrip("*") + "]")                # 오른쪽 특정문자 제거
print("[" + a.lstrip("*") + "]")                 # 양쪽 특정문자 제거


s = "Python is fun. I love Python."

# # 부분 문자열이 처음 등장하는 위치(인덱스)를 알려주는 문자열 메소드
print(a.find("python"))             # 인덱스 반환
print(a.index("python"))            # 인덱스 반환

# print(a.find("java"))               # 인덱스 반환 ( 없으면 )
# print(a.index("java"))            # 인덱스 반환 ( 없으면 )

# # 부분 문자열이 몇 번 나오는지 알려주는 문자열 메소드
print(s.count("the"))                 # 등장 횟수

# # 문자열 포함여부를 알려주는 연산자
print("the" in s)                # 포함(True)
...
print(email.count("@dimigo.hs.kr")>=1)            # ✅ "@dimigo.hs.kr"이 포함되어 있으면 True
